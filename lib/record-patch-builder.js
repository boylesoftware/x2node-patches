...
class RecordPatchOperation {
	 ...
	 *
	 * @param {module:x2node-patches~PropertyPointer} pathPtr Pointer for the
 ...
 *
 * @private
 * @param {module:x2node-patches~PropertyPointer} ptr The pointer.
 * @param {Object} record The record.
...
class MoveRecordPatchOperation extends RecordPatchOperation {
	 ...
	 * @param {module:x2node-patches~PropertyPointer} pathPtr Pointer for the
	 * property, to which the operation is applied.
	 * @param {module:x2node-patches~PropertyPointer} fromPtr Pointer for the
	 * property to move.
	 */
...
class RecordPatch {
	 ...
	 * [buildJSONPatch()]{@link module:x2node-patches.buildJSONPatch} function.
	 *
	 * @private
 ...
 *
 * @function module:x2node-patches.buildJSONPatch
 ...
 * @returns {module:x2node-patches~PropertyPointer} The resolved property.
 ...
 * @param {module:x2node-patches~PropertyPointer} pathPtr Information object for
 ...
 * @param {module:x2node-patches~PropertyPointer} fromPtr Information object for
 * the "from" property.
 * @param {boolean} forMove <code>true</code> if moving, <code>false</code> if
 * copying.
 * @returns {module:x2node-patches~PropertyPointer} The pointer passed in as the
 * <code>fromPtr</code>.
 ...
 *
 * @private
 * @param {module:x2node-patches~PropertyPointer} pathPtr Resolved property
 * pointer.
 * @param {Set.<string>} involvedPropPaths Involved property paths collection.
 * @returns {module:x2node-patches~PropertyPointer} The pointer passed in as
 * <code>pathPtr</code>.
 */
