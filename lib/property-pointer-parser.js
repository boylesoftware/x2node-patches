...
class PropertyPointer {
	 ...
	 * [parseJSONPointer()]{@link module:x2node-patch.parseJSONPointer} function.
	 *
	 * @private
	 * @param {?module:x2node-patch~PropertyPointer} parent Parent pointer, or
	 ...
	 * @returns {module:x2node-patch~PropertyPointer} Child property pointer.
	 ...
	 * @returns {module:x2node-patch~PropertyPointer} Child pointer.
	 * @throws {module:x2node-common.X2UsageError} If resulting pointer would be
	 * invalid.
	 */
	 ...
	 *
	 * @callback module:x2node-patch~PropertyPointer~traceCallback
	 * @param {module:x2node-patch~PropertyPointer} prefixPtr The pointer
	 ...
	 * @param {module:x2node-patch~PropertyPointer~traceCallback} [traceFunc]
	 ...
	 * [removeValue()]{@link module:x2node-patch~PropertyPointer#removeValue}
	 ...
	 * [getValue()]{@link module:x2node-patch~PropertyPointer#getValue} was
	 ...
	 *
	 * @param {module:x2node-patch~PropertyPointer} otherPtr The other pointer.
 ...
 *
 * @function module:x2node-patch.parseJSONPointer
 ...
 * @returns {module:x2node-patch~PropertyPointer} Parsed property pointer.
