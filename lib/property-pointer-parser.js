...
class PropertyPointer {
	 ...
	 * [parseJSONPointer()]{@link module:x2node-patches.parseJSONPointer}
	 * function.
	 *
	 * @private
	 * @param {?module:x2node-patches~PropertyPointer} parent Parent pointer, or
	 ...
	 * @returns {module:x2node-patches~PropertyPointer} Child property pointer.
	 ...
	 * @returns {module:x2node-patches~PropertyPointer} Child pointer.
	 * @throws {module:x2node-common.X2UsageError} If resulting pointer would be
	 * invalid.
	 */
	 ...
	 *
	 * @callback module:x2node-patches~PropertyPointer~traceCallback
	 * @param {module:x2node-patches~PropertyPointer} prefixPtr The pointer
	 ...
	 * @param {module:x2node-patches~PropertyPointer~traceCallback} [traceFunc]
	 ...
	 * [removeValue()]{@link module:x2node-patches~PropertyPointer#removeValue}
	 ...
	 * [getValue()]{@link module:x2node-patches~PropertyPointer#getValue} was
	 * called for the pointer before modifying the record.
	 ...
	 *
	 * @param {module:x2node-patches~PropertyPointer} otherPtr The other pointer.
 ...
 *
 * @function module:x2node-patches.parseJSONPointer
 ...
 * @returns {module:x2node-patches~PropertyPointer} Parsed property pointer.
